...
export default {
    ...
    getLatelyWeek() {
        ...
        obj.starttime = moment((new Date()).getTime() - 3600 * 1000 * 24 * 7).format('YYYY-MM-DD HH:mm:ss');
        obj.endtime = moment(new Date()).format('YYYY-MM-DD HH:mm:ss');
        return obj
    },
    // 获取最近30天的开始结束时间
    getLatelyMonth() {
        ...
        obj.starttime = moment((new Date()).getTime() - 3600 * 1000 * 24 * 30).format('YYYY-MM-DD HH:mm:ss');
        obj.endtime = moment(new Date()).format('YYYY-MM-DD HH:mm:ss');
        return obj
    },
}